...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask?: { __typename?: 'CreateTaskPayload', task: { __typename?: 'Task', id: string, title: string, detail?: string | null, limitOn: any, statusId?: string | null, userId?: string | null } } | null };
...
export type ImportTaskMutation = { __typename?: 'Mutation', importTask?: { __typename?: 'ImportTaskPayload', message: string } | null };
...
export type FetchTasksQuery = { __typename?: 'Query', tasks: { __typename?: 'TaskConnection', edges?: Array<{ __typename?: 'TaskEdge', node?: { __typename?: 'Task', id: string, title: string, detail?: string | null, limitOn: any, status?: { __typename?: 'Status', id: string, name: string } | null } | null } | null> | null, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean, startCursor?: string | null, endCursor?: string | null } } };

export type FetchUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, name?: string | null, email?: string | null }> };
...
export const ImportTaskDocument = gql`
  ...
  importTask(input: {file: $file}) {
    ...
    `;
export type ImportTaskMutationFn = Apollo.MutationFunction<ImportTaskMutation, ImportTaskMutationVariables>;
 ...
 * });
 */
export function useImportTaskMutation(baseOptions?: Apollo.MutationHookOptions<ImportTaskMutation, ImportTaskMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ImportTaskMutation, ImportTaskMutationVariables>(ImportTaskDocument, options);
      }
export type ImportTaskMutationHookResult = ReturnType<typeof useImportTaskMutation>;
export type ImportTaskMutationResult = Apollo.MutationResult<ImportTaskMutation>;
export type ImportTaskMutationOptions = Apollo.BaseMutationOptions<ImportTaskMutation, ImportTaskMutationVariables>;
...
export const FetchTasksDocument = gql`
    query FetchTasks($first: Int, $last: Int, $before: String, $after: String, $from: String, $to: String, $title: String) {
  tasks(
    first: $first
    last: $last
    before: $before
